...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="If > 0, generate this many local canonical examples in generate_data",
    )
    parser.add_argument(
        "--canonical-output",
        default=None,
        help="Optional path for local canonical dump generated by generate_data",
    )
    parser.add_argument(
        "--canonical-streaming",
    ...
    if args.canonical_count > 0:
        cmd.extend(
            [
                ...
                "--canonical-count",
                str(args.canonical_count),
            ]
        )
        if args.canonical_output:
            cmd.extend(["--canonical-output", args.canonical_output])
    run(cmd, python_exec)
